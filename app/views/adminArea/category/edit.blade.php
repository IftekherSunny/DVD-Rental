...
@section('content')
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4><span class="glyphicon glyphicon-play"></span> Category Edit</h4>
		</div>
		<div class="panel-body">
			<div class="row panel-body-form">
				...
				<form action=" {{ URL::route('category-edit-post')}} " method="POST" class="form-horizontal" role="form">						
					<!-- Holding id -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('name')) ? ' value="'. Input::old('name') .'"' : 'value="'. $category->name .'"'}} class="form-control app-textbox" name="name" placeholder="Category Name">
						</div>
