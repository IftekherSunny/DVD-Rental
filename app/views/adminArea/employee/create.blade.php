...
@section('content')
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4><i class="fa fa-user"></i> Employee Create</h4>
		</div>
		<div class="panel-body">
			<div class="row panel-body-form">
				...
				<form action=" {{ URL::route('employee-create-post')}} " method="POST" class="form-horizontal" role="form">						
					...
					<!-- start of user level -->
					<div class="form-group">
						<label for="userlevel" class="col-sm-2 col-sm-offset-1 control-label">User Level<b class="star"> *</b></label>
						<div class="col-sm-5">	
							<select id="userlevel" name="userlevel"> 	
							  <option value="" selected>Select your option</option>
							  @if(e(Input::old('userlevel')) == 'admin')
							  	<option selected value="admin">Admin</option>
							  @else
							  	<option value="admin">Admin</option>
							  @endif
							  @if(e(Input::old('userlevel')) == 'employee')
						...
						<div class="col-sm-4 form-error-msg">
							<label class="label label-danger"> {{ $errors->first('userlevel')}} </label>
						</div>
						@endif
					</div> <!-- end of userlevel -->
