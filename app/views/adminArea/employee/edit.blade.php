...
@section('content')
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4><i class="fa fa-user"></i> Employee Edit</h4>
		</div>
		<div class="panel-body">
			<div class="row panel-body-form">
				...
				<form action=" {{ URL::route('employee-edit-post')}} " method="POST" class="form-horizontal" role="form">						
					<!-- Holding id -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('first_name')) ? ' value="'. Input::old('first_name') .'"' : 'value="'. $employee->first_name .'"'}} class="form-control app-textbox" name="first_name" placeholder="First Name">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('last_name')) ? ' value="'. Input::old('last_name') .'"' : 'value="'. $employee->last_name .'"'}} class="form-control app-textbox" name="last_name" placeholder="Last Name">
						</div>
							 ...
							 <option value="" selected>Select your option</option>
								@for($i=15; $i<101; $i++)
									@if(e(Input::old('age')))
								  	...
								  	@else
								  		<option {{ ($employee->age== $i) ? 'selected' : ''}} value="{{$i}}">{{$i}}</option>
								  	@endif
								@endfor
							</select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">	
							<select id="gender" name="gender">
							  ...
							  @elseif( ($employee->gender=='Male') && (e(Input::old('gender') !== '')))
							  ...
							  @elseif( ($employee->gender=='Female') && (e(Input::old('gender') !== '')))
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" {{ e(Input::old('DOB')) ? ' value="'. Input::old('DOB') .'"' : 'value="'. $employee->DOB .'"'}} class="form-control" name="DOB" placeholder="01-01-2014" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY']" data-beatpicker-module="clear">
						</div>
						@if($errors->has('DOB'))
						<div class="col-sm-4 form-error-msg">
					...
					<div class="form-group">
						...
						<div class="col-sm-5 create">
							<textarea class="form-control app-textbox" name="present_address" placeholder="Present Address" rows="3">{{ e(Input::old('present_address')) ? Input::old('present_address') : $employee->present_address }}</textarea>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5 create">
							<textarea class="form-control app-textbox" name="permanent_address" placeholder="Permanent Address" rows="3">{{ e(Input::old('permanent_address')) ? Input::old('permanent_address') : $employee->permanent_address }}</textarea>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('city')) ? ' value="'. Input::old('city') .'"' : 'value="'. $employee->city .'"'}} class="form-control app-textbox" name="city" placeholder="City">
						</div>
						@if($errors->has('city'))
						<div class="col-sm-4 form-error-msg">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('state')) ? ' value="'. Input::old('state') .'"' : 'value="'. $employee->state .'"'}} class="form-control app-textbox" name="state" placeholder="state">
						</div>
					</div> <!-- end of state -->
							 ...
							 <option value="" selected>Select your option</option>
								@foreach(Country::$country_list as $country)
									@if(e(Input::old('country')))
								  	...
								  	@else
								  		<option {{ ($employee->country== $country) ? 'selected' : ''}} value="{{$country}}">{{$country}}</option>
								  	@endif
								@endforeach
							</select> 
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" {{ e(Input::old('mobile_no')) ? ' value="'. Input::old('mobile_no') .'"' : 'value="'. $employee->mobile_no .'"'}} class="form-control app-textbox" name="mobile_no" size="30" placeholder="Mobile No">
						</div>
