	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="row panel-body-form">
				...
				<form action=" {{ URL::route('employee-details-post')}} " method="POST" class="form-horizontal" role="form">						
					<!-- Holding id -->
					<input type="hidden" value="{{ $employee->id }}" name="id">

					<!-- start of id -->
					<div class="form-group">
						<label for="employee_id" class="col-sm-2 col-sm-offset-1 control-label">#ID</label>
						<div class="col-sm-5">
						  <input type="text" value="EMP-{{ $employee->id }}"  readonly class="form-control app-textbox" name="employee_id">
						</div>
					</div> <!-- end of id -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{ $employee->first_name }}"  readonly class="form-control app-textbox" name="first_name">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->last_name}}" readonly class="form-control app-textbox" name="last_name">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->age}}" readonly class="form-control app-textbox" name="age">
						</div>
					</div> <!-- end of age -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" value="{{$employee->DOB}}" readonly class="form-control" name="DOB">
						</div>
					</div>
					<!-- end of DOB -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea class="form-control app-textbox" readonly rows="5">{{$employee->present_address}}</textarea>						  
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <textarea class="form-control app-textbox" readonly rows="5">{{$employee->permanent_address}}</textarea>	
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->city}}" readonly  class="form-control app-textbox" name="city">
						</div>
					</div> <!-- end of city -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->state}}" readonly  class="form-control app-textbox" name="state">
						</div>
					</div> <!-- end of state -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->mobile_no}}" readonly  class="form-control app-textbox" name="mobile_no" size="30">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->email}}" readonly  class="form-control app-textbox" name="eamil">
						</div>
					</div> <!-- end of email -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						  <input type="text" value="{{$employee->user()->username}}" readonly  class="form-control app-textbox" name="username">
						</div>
					</div> <!-- end of username -->
...
@stop
	...
	<form action="{{ URL::route('employee-order-deactive-post')}}" method="post">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4 class="username"><i class="fa fa-list"></i> {{ $employee->user()->username }}'s Active Order</h4> 
			...
			<div class="panel-body">
				<table class="table table-striped table-bordered table-hover" id="dataTables-example">
					...
					@foreach ($orders as $order)
							...
							@if($statusActive && ($order->employee_id == $employee->id))
							<tr class="capitalize">
