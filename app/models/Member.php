...
class Member extends Eloquent
{
	 ...
	 * Fillable
	 */
	protected $fillable =  array('first_name','last_name','age','gender','DOB','present_address','parmanent_address','city','state','country','mobile_no','email','created_by');
	...
	/**
	 * int 1 represents user is active and 0 represents user needs to confirm
	 * @return Return Active member
	 */
	...
	/**
	 * This function deletes user by member id
	 * @param  [int] $id [Need member id]
	 */
